...
class ReportsPage(QWidget):
    ...
    def _build_report_text(self) -> str:
        ...
        for label, report in (("PRIMARY", primary), ("DR", dr)):
            ...
            lines.append(f"  vCPU demand         : {report.vcpu_demand}")
            lines.append(f"  RAM demand          : {report.ram_demand_gb:.0f} GB")
            lines.append(f"  Disk demand         : {report.disk_demand_gb / 1024:.2f} TB")
